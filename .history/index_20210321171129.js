...
async function load() {
    ...
    let  link_cate = ".\cate_api.json"
    let link_product = ".\products_api.json"
    // let  link_cate = 'http://localhost:8080/api/categories'
    // let link_product = 'http://localhost:8080/api/products?size=100'
    let fetchProducts = await fetch(link_product);
    let fetchCategories = await fetch(link_cate);
